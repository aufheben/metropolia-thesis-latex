...
\begin{itemize}
  ...
  \item \mintinline{c}{kH} and \mintinline{c}{kW} are the height and width of each convolutional kernel channel
  \item Each kernel is also a $3D$ tensor with dimensions \mintinline{c}{(nInputChannel, kH, kW)}
  \item $nOutputChannel$ is the number of output channels
\end{itemize}
