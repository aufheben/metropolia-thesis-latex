...
\mintinline{c}{gemm} can be splitted into three nested for-loop indexed by \mintinline{c}{c_im}, \mintinline{c}{h_offset} and \mintinline{c}{w_offset}.
Similarly, the for-loop indexed by \mintinline{c}{i} in \mintinline{c}{gemm} is equivalent to the two
nested for-loop indexed by $h_col$ and $w_col$, same as in \mintinline{c}{col2im}.
