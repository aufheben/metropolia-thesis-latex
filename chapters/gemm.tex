...
\mintinline{c}{gemm} can be splitted into three nested for loops indexed by $c_im$, $h_offset$ and $w_offset$.
Similarly, the for loop indexed by \mintinline{c}{i} in \mintinline{c}{gemm} is equivalent to the two
nested for loops indexed by $h_col$ and $w_col$, same as in \mintinline{c}{col2im}.
