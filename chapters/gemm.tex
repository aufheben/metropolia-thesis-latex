...
A naïve implementation of GEMM is shown in Listing \ref{code:naivegemm}. Here, $lda$, $ldb$ and $ldc$ are
...
and places them in the destination image. The code is given in Listing \ref{code:col2im}:
...
For transposed convolution, $data\_im$ is typically smaller than $data\_col$. This leads to a key optimization
